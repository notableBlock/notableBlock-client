...
function MyNotePage() {
  ...
  const {
    notesState: { fetchedNotes },
    noteActions: { handleCreateNewNote, handleSelectMenu },
    fetchActions: { getUserNotes },
    fileActions: { handleImportFromLocal, handleArchiveUploadedFiles },
    menuHelpers: { getMenu },
